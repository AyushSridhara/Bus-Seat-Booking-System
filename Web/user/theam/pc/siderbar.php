...
<div class="sidebar nonepc">
  ...
  <a href="book.php" class ="bookd"><i class="fa-solid fa-ticket icco bookd"></i> Book</a>
  <a href="my_booking.php" class ="mybookd"><i class="fa-solid fa-bookmark icco mybookd"></i> My Booking</a>
