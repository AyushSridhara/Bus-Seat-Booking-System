            ...
            <nav class="nav container">
                ...
                <div class="nav__menu" id="nav-menu">
                    <ul class="nav__list">
                        ...
                        <li class="nav__item">
                            <a href="book.php" class="nav__link bookdm">
                                <i class="fa-solid fa-ticket nav__icon"></i>
                                <span class="nav__name bookdm">Book</span>
                            </a>
                        </li>

                        <li class="nav__item">
                            <a href="my_booking.php" class="nav__link booikmd">
                                <i class="fa-solid fa-bookmark nav__icon"></i></i>
                                <span class="nav__name booikmd">My Booking</span>
                            </a>
                        </li>
