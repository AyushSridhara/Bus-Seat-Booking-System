...
<div class="bgcol">
    ...
    <div class="leftget ">
        <i class="fa-solid fa-bus nav__icon" style="font-size:15px;color:black;"> BUS</i>
    </div>


  <div class = "addbus " >
    <button  class='btn btn-success ' data-toggle='modal' data-target='#myModal'  onclick=(addbus())   >+ Add to bus</button>
  </div>
...
<form action="bus.php" method="post" class="mform">
...
<input type="date" placeholder="date" name="date" class="moselbox "><br>
        ...
        <label for="uname"  class="padiscr"><b>Route -</b></label><br>
