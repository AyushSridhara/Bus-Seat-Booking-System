...
<div class="search disn" >
    ...
    <br>
<div class = "addbus" >
    <button  class='btn btn-success btnlftadsdd' data-toggle='modal' data-target='#myModal'  onclick=(addbus())   >+ Add to bus</button>
</div>
...
<script>
setTimeout(function() { alert("Bus Added !"); }, 500);
</script>
...
<script>
setTimeout(function() { alert("Bus Removed !"); }, 500);
</script>
...
<script>
setTimeout(function() { alert("Edit done !"); }, 500);
</script>
