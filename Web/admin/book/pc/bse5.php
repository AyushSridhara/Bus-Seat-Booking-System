...
<form action="book/pc/busedit.php" method="POST">
  ...
  <div class="form-group padding2">
    ...
    <input type="date" class="form-control colwef" id="date" name = "date"  value = "<?php echo $date; ?>" aria-describedby="emailHelp" required>
  </div>

  <div class="form-group padding2">
    <label for="exampleInputEmail1">Time</label>
    <input type="time" class="form-control colwef" id="time" name = "time" value = "<?php echo $time; ?>" aria-describedby="emailHelp" required>
  </div>

  <div class="form-group padding2">
    <label for="exampleInputEmail1">Price</label>
    <input type="text" class="form-control colwef" id="price" name="price" value = "<?php echo $price; ?>" aria-describedby="emailHelp " required>
  </div>
  ...
  <input type="text" class ="buid" id="uid" name="uid" value="<?php  echo $bid  ?>" readonly>
...
*/
			$(document).ready(function() {
				var city = [  "<?php echo $to; ?>","Ampara","Anuradhapura","Badulla","Balangoda","Batticaloa","Chavakachcheri","Chilaw",
         ...
         */       
			...
			$(document).ready(function() {
				var ccity = [  "<?php echo $from; ?>","Ampara","Anuradhapura","Badulla","Balangoda","Batticaloa","Chavakachcheri","Chilaw",
                                    "Colombo","Dambulla", "Eravur", "Galle","Hambantota","Jaffna","Kalmunai", "Kandy", "Kattankudy",
                                    "Kilinochchi", "Kinniya", "Kurunegala", "Mannar", "Matale", "Matara", "Mullaitivu", "Negombo", "Point Pedro",
                                    "Polonnaruwa", "Puttalam", "Ratnapura", "Trincomalee",  "Valvettithurai", "Vavuniya", "Wattala", "Ambalangoda", "Beruwala",
                                    "Hikkaduwa", "Nuwara Eliya", "Weligama", "Kegalle","Kalutara", "Moratuwa", "Panadura", "Ja-Ela", "Gampola",
