...
if($root == "All"){
  ...
  if($result->num_rows >0){
          ...
          while ($row = $result->fetch_assoc()) {
                  ...
                  <button  class='btn btn-primary btn-sm btn-sme ' data-toggle='modal' data-target='#myModal'  onclick=(editproduct(this.id))   id = '".$row["id"]."'>Edit</button>
                  <button  class='btn btn-danger btn-sm btn-sme' data-toggle='modal' data-target='#myModal'  onclick=(remove(this.id))   id=$row[id]'>Delete</button>
