...
<div class="search disn dispn" >
    <form id="sercformpcbo" class="seform" >
            ...
            <label for="uname" class="tisepad toppe datep" ><b>Date -</b></label>
...
nav .navbar .nav-links .links li .btime{
    color:#0D6E8D;
}
...
setTimeout(function() { alert("Seet Booked Done !"); }, 500);
</script>
