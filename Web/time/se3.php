...
if($root == "All"){
  ...
  if($result->num_rows >0){
          ...
          while ($row = $result->fetch_assoc()) {
                  ...
                  <a href='user/book.php' ><button  class='btn btn-primary btn-sm btn-sme ' data-toggle='modal' data-target='#myModal'  onclick=(editproduct(this.id))   id = '".$row["id"]."'>Book</button></a>
